...
이 책은 Rust에 대한 경험이 있는 사람들을 대상으로 하며, 임베디드 개발 및 전자제품에 대한 초보적인 지식을 전제로 합니다. 위 경험이 없는 사람들에게는 먼저 [가정 및 전제조건][prerequisites]과 [리소스][resources]섹션을 읽어보고 최신 정보를 얻도록 권장합니다
